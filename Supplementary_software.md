...
Acquire required packages. Installation takes less than 15 minutes on a
standard laptop computer. Run the code block below to install the
required packages. Code run using R version 3.6.1
...
```
    ...
    ## 5       Other vs Veillonella  3.006875 0.1366334   0.004     0.0040   *
...
```
    ...
    ##                        pairs  F.Model         R2 p.value p.adjusted sig
    ## 1        Klebsiella vs Other 6.589081 0.19616735   0.001      0.003   *
    ## 2  Klebsiella vs Escherichia 8.589191 0.27190285   0.001      0.003   *
    ## 3  Klebsiella vs Veillonella 4.428655 0.18128935   0.002      0.004   *
    ## 4       Other vs Escherichia 1.646306 0.06962212   0.042      0.063    
    ## 5       Other vs Veillonella 1.231788 0.06088381   0.226      0.226    
    ## 6 Escherichia vs Veillonella 1.337707 0.08187849   0.170      0.204
...
```
    ...
    ##                        pairs  F.Model         R2 p.value p.adjusted sig
    ## 1        Klebsiella vs Other 1.945615 0.06721624   0.020     0.0390   .
    ## 2  Klebsiella vs Escherichia 4.530901 0.16457510   0.001     0.0060   *
    ## 3  Klebsiella vs Veillonella 1.615640 0.07474403   0.086     0.1032    
    ## 4       Other vs Escherichia 2.353726 0.09664748   0.004     0.0120   .
    ## 5       Other vs Veillonella 1.329625 0.06540330   0.144     0.1440    
    ## 6 Escherichia vs Veillonella 2.400935 0.13797733   0.026     0.0390   .
...
```
    ...
    ##                        pairs   F.Model         R2 p.value p.adjusted sig
    ## 1        Klebsiella vs Other  5.318223 0.16981240   0.001     0.0012   *
    ## 2  Klebsiella vs Escherichia 25.987757 0.54154973   0.001     0.0012   *
    ## 3  Klebsiella vs Veillonella  7.341633 0.27870835   0.001     0.0012   *
    ## 4       Other vs Escherichia  9.368032 0.29864903   0.001     0.0012   *
    ## 5       Other vs Veillonella  2.077923 0.09858289   0.032     0.0320   .
    ## 6 Escherichia vs Veillonella 12.884016 0.46205740   0.001     0.0012   *
...
The following code blocks for individual publications are for compiling
the metagenome analysis data from ARG mapping and meta-data to a
suitable format for meta-analysis GLM analyses and other analyses.
...
<https://doi.org/10.1016%2Fj.chom.2015.04.004>
    ...
    ## -------------------------- ----------- ------ ------- -------- ------
    ## (Intercept)                       0.18   0.06    0.55    -3.04   0.00
    ## Age                               0.91   0.78    1.06    -1.19   0.24
    ## FormulaTRUE                       1.29   0.70    2.35     0.82   0.42
    ## Delivery_modevaginal              1.71   0.71    4.12     1.19   0.24
    ## ---------------------------------------------------------------------
    ## 
    ## Estimated dispersion parameter = 1.2

    ## MODEL INFO:
    ## Observations: 69
    ## Dependent Variable: SUM12M
    ## Type: Generalized linear model
    ##   Family: Gamma 
    ##   Link function: log 
    ## 
    ## MODEL FIT:
    ## χ²(6) = 8.9205, p = 0.0005
    ## Pseudo-R² (Cragg-Uhler) = -0.0474
    ## Pseudo-R² (McFadden) = -0.1772
    ## AIC = -144.7817, BIC = -126.9088 
    ## 
    ## Standard errors: MLE
    ## --------------------------------------------------------------------
    ##                       exp(Est.)     2.5%    97.5%    t val.        p
    ## ------------------- ----------- -------- -------- --------- --------
    ## (Intercept)              0.0050   0.0000   4.9600   -1.5052   0.1373
    ## SUMM                     1.2321   0.5150   2.9476    0.4689   0.6408
    ## SUM                      0.9687   0.5562   1.6873   -0.1122   0.9110
    ## Age                      1.0081   0.9894   1.0272    0.8431   0.4024
    ## SUM4M                    4.1740   1.9848   8.7781    3.7673   0.0004
    ## AB_12M                   0.8256   0.6419   1.0620   -1.4920   0.1408
    ## Formula4MTRUE            1.5106   1.0750   2.1226    2.3769   0.0206
    ## --------------------------------------------------------------------
    ## 
    ## Estimated dispersion parameter = 0.3705
...
(Second author last name used for shortness for this publication in the
code block. First author is Baumann-Dudenhoeffer, A.M.)
...
```
    ...
    ## Joining, by = c("SUM", "SUM4M", "Age", "SUM12M", "Formula4M")
...
The following code is for harmonizing and compiling metadata for
meta-analysis steps.
...
![](Supplementary_software_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
Read Metaphlan results from the meta-analysis datasets and find top taxa
in each
sample.
...
![](Supplementary_software_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
```
    ...
    ##  [1] pscl_1.5.2                  ggsignif_0.6.0             
    ##  [3] wesanderson_0.3.6           multcomp_1.4-10            
    ##  [5] TH.data_1.0-10              survival_3.1-8             
    ##  [7] mvtnorm_1.0-11              jtools_2.0.1               
    ##  [9] MASS_7.3-51.4               svglite_1.2.2              
    ## [11] lmSupport_2.9.13            lme4_1.1-21                
    ## [13] Matrix_1.2-18               ggrepel_0.8.1              
    ## [15] data.table_1.12.6           caret_6.0-84               
    ## [17] randomForest_4.6-14         cowplot_1.0.0              
    ## [19] dplyr_0.8.3                 rmarkdown_1.17             
    ## [21] DESeq2_1.24.0               SummarizedExperiment_1.14.1
    ## [23] DelayedArray_0.10.0         BiocParallel_1.18.1        
    ## [25] matrixStats_0.55.0          Biobase_2.44.0             
    ## [27] GenomicRanges_1.36.1        GenomeInfoDb_1.20.0        
    ## [29] IRanges_2.18.3              S4Vectors_0.22.1           
    ## [31] BiocGenerics_0.30.0         knitr_1.26                 
    ## [33] ggplot2_3.2.1               phyloseq_1.28.0            
    ## [35] vegan_2.5-6                 lattice_0.20-38            
    ## [37] permute_0.9-5              
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] readxl_1.3.1           backports_1.1.5        Hmisc_4.3-0           
    ##   [4] VGAM_1.1-1             systemfonts_0.1.1      plyr_1.8.4            
    ##   [7] igraph_1.2.4.1         lazyeval_0.2.2         sp_1.3-2              
    ##  [10] splines_3.6.2          unmarked_0.13-0        digest_0.6.22         
    ##  [13] foreach_1.4.7          htmltools_0.4.0        gdata_2.18.0          
    ##  [16] magrittr_1.5           checkmate_1.9.4        memoise_1.1.0         
    ##  [19] AICcmodavg_2.2-2       cluster_2.1.0          openxlsx_4.1.3        
    ##  [22] recipes_0.1.7          Biostrings_2.52.0      annotate_1.62.0       
    ##  [25] gower_0.2.1            sandwich_2.5-1         colorspace_1.4-1      
    ##  [28] blob_1.2.0             haven_2.2.0            xfun_0.11             
    ##  [31] crayon_1.3.4           RCurl_1.95-4.12        jsonlite_1.6          
    ##  [34] genefilter_1.66.0      zeallot_0.1.0          zoo_1.8-6             
    ##  [37] iterators_1.0.12       ape_5.3                glue_1.3.1            
    ##  [40] gtable_0.3.0           ipred_0.9-9            zlibbioc_1.30.0       
    ##  [43] XVector_0.24.0         car_3.0-4              Rhdf5lib_1.6.3        
    ##  [46] abind_1.4-5            scales_1.0.0           DBI_1.0.0             
    ##  [49] Rcpp_1.0.3             xtable_1.8-4           htmlTable_1.13.2      
    ##  [52] foreign_0.8-72         bit_1.1-14             Formula_1.2-3         
    ##  [55] lava_1.6.6             prodlim_2019.10.13     htmlwidgets_1.5.1     
    ##  [58] gplots_3.0.1.1         RColorBrewer_1.1-2     acepack_1.4.1         
    ##  [61] pkgconfig_2.0.3        XML_3.98-1.20          nnet_7.3-12           
    ##  [64] locfit_1.5-9.1         labeling_0.3           tidyselect_0.2.5      
    ##  [67] rlang_0.4.1            reshape2_1.4.3         AnnotationDbi_1.46.1  
    ##  [70] munsell_0.5.0          cellranger_1.1.0       tools_3.6.2           
    ##  [73] generics_0.0.2         RSQLite_2.1.2          ade4_1.7-13           
    ##  [76] evaluate_0.14          biomformat_1.12.0      stringr_1.4.0         
    ##  [79] yaml_2.2.0             ModelMetrics_1.2.2     bit64_0.9-7           
    ##  [82] pander_0.6.3           zip_2.0.4              caTools_1.17.1.2      
    ##  [85] purrr_0.3.3            nlme_3.1-142           pbkrtest_0.4-7        
    ##  [88] compiler_3.6.2         rstudioapi_0.10        curl_4.2              
    ##  [91] tibble_2.1.3           geneplotter_1.62.0     stringi_1.4.3         
    ##  [94] highr_0.8              gdtools_0.2.1          forcats_0.4.0         
    ##  [97] psych_1.8.12           nloptr_1.2.1           multtest_2.40.0       
    ## [100] vctrs_0.2.0            pillar_1.4.2           pwr_1.2-2             
    ## [103] bitops_1.0-6           raster_3.0-7           R6_2.4.1              
    ## [106] latticeExtra_0.6-28    KernSmooth_2.23-16     gridExtra_2.3         
    ## [109] rio_0.5.16             codetools_0.2-16       boot_1.3-23           
    ## [112] gtools_3.8.1           assertthat_0.2.1       rhdf5_2.28.1          
    ## [115] withr_2.1.2            mnormt_1.5-5           GenomeInfoDbData_1.2.1
    ## [118] mgcv_1.8-31            hms_0.5.2              grid_3.6.2            
    ## [121] rpart_4.1-15           timeDate_3043.102      class_7.3-15          
    ## [124] minqa_1.2.4            carData_3.0-2          gvlma_1.0.0.3         
